...
**web4 - (ключевые слова: Spring, React, Hibernate, PostgreSQL, JPA, JWT, Validator, авторизация пользователя)**

*Задание:*

Переписать приложение с использованием следующих технологий:
...
"Десктопный" - для устройств, ширина экрана которых равна или превышает 1186 пикселей.
"Планшетный" - для устройств, ширина экрана которых равна или превышает 650, но меньше 1186 пикселей.
"Мобильный"- для устройств, ширина экрана которых меньше 650 пикселей.
...
Набор полей ввода для задания координат точки и радиуса области в соответствии с вариантом задания: Button {'-4','-3','-2','-1','0','1','2','3','4'} для координаты по оси X, Input (-5 ... 3) для координаты по оси Y, и Button {'-4','-3','-2','-1','0','1','2','3','4'} для задания радиуса области. Если поле ввода допускает ввод заведомо некорректных данных (таких, например, как буквы в координатах точки или отрицательный радиус), то приложение должно осуществлять их валидацию.
...
<img width="301" alt="Screenshot 2025-04-07 at 15 01 44" src="https://github.com/user-attachments/assets/fea05031-8f71-46d4-8b57-c40fbaac243d" />

**web3 - (ключевые слова: JSF, Beans, компоненты, PrimeFaces, пагинация, динамически обновляемая картинка, PostgreSQL, Hibernate, SessionScoped Managed Bean, аннотации**
...
<img width="322" alt="Screenshot 2025-04-07 at 15 03 10" src="https://github.com/user-attachments/assets/75674e26-1660-4fe8-b1a4-51ad0ca54a15" />

**web2 - (ключевые слова: сервлеты, JSP, шаблон MVC, пагинация, Beans, WildFly, обработка клика пользователя js-скриптом)**
...
**web (ключевые слова: FastCGI, Apache, httpd, GET-запрос, AJAX, табличная вёрстка, селекторы, svg в js)**
